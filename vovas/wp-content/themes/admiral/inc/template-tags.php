...
function admiral_footer_text() {
	...
	<span class="credit-link">
		<?php printf( esc_html__( ' %1$s / %2$s', 'admiral' ),
			'<a href="http://wp-templates.ru/" title="Шаблоны WordPress">WordPress</a>',
			'<a href="https://themezee.com/themes/admiral/" title="Admiral WordPress Theme">Admiral</a> / <a href="http://builderbody.ru/skolko-nuzhno-pit-vody-v-den/" rel="nofollow" title="Сколько нужно пить воды в день" target="_blank">Вода</a>'
		); ?>
	</span>
